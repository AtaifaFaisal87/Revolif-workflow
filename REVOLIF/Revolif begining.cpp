// ============================================================
//              LIFE MANAGER - UPDATED VERSION 2.0
// ============================================================
...
public:
    ...
    void displaySpendingChart() const
    {
        ...
        {
            int barLength = (maxVal > 0) ? (int)((totals[i] / maxVal) * maxBarLength) : 0;
            cout << setw(15) << left << categories[i] << " [";
            for (int b = 0; b < maxBarLength; b++)
                cout << (b < barLength ? '#' : ' ');
            cout << "] " << fixed << setprecision(2) << totals[i] << endl;
        }
        cout << "=====================================\n";
    }
};
...
public:
    ...
    void generateMonthlyReport(User &user)
    {
        ...
        report << "====================================================\n";
        report << "              LIFE MANAGER - MONTHLY REPORT\n";
        report << "====================================================\n";
