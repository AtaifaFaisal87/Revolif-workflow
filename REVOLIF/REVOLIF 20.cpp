...
void showLoadingStep(const string &message, int percent)
{
    ...
    // ANSI color codes for a modern, clean look
    const string COLOR_FILL = "\033[36m";  // Cyan for filled portion
    const string COLOR_EMPTY = "\033[90m"; // Bright black (gray) for empty
    const string COLOR_PCT = "\033[97m";   // Bright white for percentage
    const string COLOR_MSG = "\033[37m";   // White for message
...
public:
    ...
    User *registerUser()
    {
        ...
        while (true)
        {
            ...
            {
                throw UserException("THIS USERNAME IS ALREADY TAKEN! PLEASE CHOOSE ANOTHER.");
            }
            break;
        }
...
public:
    ...
    void adminSearchUsers()
    {
        ...
        if (!found)
            throw NotFoundException("NO USERS FOUND MATCHING: " + query);
    }
    ...
    void adminViewInactiveUsers()
    {
        ...
        if (!found)
            throw NotFoundException("NO INACTIVE USERS.");
    }
    ...
    void mainMenu()
    {
        ...
        do
        {
            ...
            try
            {
                ...
                case 2:
                {
                    User *newUser = auth.registerUser();
                    if (newUser)
