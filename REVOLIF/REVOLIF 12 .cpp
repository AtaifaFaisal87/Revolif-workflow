...
// ---- Lightweight, non-blocking loading bar ----
// Draws instantly with no sleep/delay of any kind; it only reflects
// progress as real startup work completes, so it never adds latency.
